...
output "tableflow-rest-endpoint" {
  value = "https://tableflow.${confluent_kafka_cluster.bootcamp.region}.aws.confluent.cloud/${confluent_tableflow_topic.movement.table_formats[0]}/catalog/organizations/${data.confluent_organization.bootcamp.id}/environments/${confluent_environment.rails_environment.id}"
}
